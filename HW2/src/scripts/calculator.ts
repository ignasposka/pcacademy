...
export default class Calculator {
    ...
    public static accomodationLoanCalculation(e: Event): void {
        ...
        const resultInput = (<HTMLInputElement>document.getElementById('result'));
        const maxAmountResultInput = (<HTMLInputElement>document.getElementById('max-amount-result'));
        ...
        const maxLoan = accomodationLoan.calculateMaxLoan();
        maxAmountResultInput.value = maxLoan.toString();
    }
}